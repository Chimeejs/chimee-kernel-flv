...
var _xhrRange = __webpack_require__(12);
...
var _xhrMozChunk = __webpack_require__(14);
...
var _mseController = __webpack_require__(8);

var _mseController2 = _interopRequireDefault(_mseController);

var _transmuxer = __webpack_require__(9);
...
var _chimeeHelper = __webpack_require__(18);
...
var _chimeeHelperLog = __webpack_require__(2);
    ...
    value: function appendBuffer(data, type) {
      try {
        ...
        if (e.code === 22) {
          ...
          this.emit('error', { errno: _$const.ERRORNO.APPENDBUFFER_ERROR, errmsg: e });
        }
      }
    }
...
var _webworkifyWebpack = __webpack_require__(15);
...
var Transmuxer = function (_CustEvent) {
  ...
  function Transmuxer(mediaSource, config, globalEvent) {
    ...
    if (_this.config.webWorker) {
      _this.w = (0, _webworkifyWebpack2.default)(/*require.resolve*/(16));
...
var _handleQuery = __webpack_require__(11);
	...
	_createClass(FetchLoader, [{
		...
		value: function open(range, keyframePoint) {
			...
			fetch(this.src, params).then(function (res) {
				...
				_this2.emit('error', { errno: _$const.ERRORNO.NET_ERROR, errmsg: e });
			});
		}
