...
var _chimeeHelper = __webpack_require__(17);
  ...
  _createClass(Flv, [{
    ...
    value: function load(src) {
      ...
      this.transmuxer.on('mediaInfo', function (mediaInfo) {
        if (!_this5.mediaInfo) {
          ...
          _this5.video.addEventListener('seeking', (0, _chimeeHelper.throttle)(_this5._seek.bind(_this5), 200, { leading: false }));
        }
      });
    ...
    value: function refresh() {
      if (this.transmuxer) {
        ...
        _chimeeHelper.Log.verbose(this.tag, 'transmuxer not ready');
      }
    }
  }]);
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.chimeeHelper = {});
})(undefined, function (exports) {
  'use strict';
