...
(function (global, factory) {
  ( false ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.chimeeHelperEvents = global.chimeeHelperEvents || {});
  ...
  var _addToUnscopables = function _addToUnscopables() {/* empty */};
  ...
  'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), i$1 = 0; symbols.length > i$1;) {
    _wks(symbols[i$1++]);
  }for (var symbols = _objectKeys(_wks.store), i$1 = 0; symbols.length > i$1;) {
    _wksDefine(symbols[i$1++]);
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() :  true ? !(__WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : global.chimeeHelperLog = factory();
})(undefined, function () {
  'use strict';
...
var _xhrRange = __webpack_require__(11);

var _xhrRange2 = _interopRequireDefault(_xhrRange);

var _websocket = __webpack_require__(12);

var _websocket2 = _interopRequireDefault(_websocket);

var _xhrMozChunk = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chimee_helper_events__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_chimee_helper_events___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_chimee_helper_events__);

/**
 * chimee-flv2fmp4 v0.2.4
...
var foreign = function (_CustEvent) {
    ...
    return foreign;
}(__WEBPACK_IMPORTED_MODULE_0_chimee_helper_events__["CustEvent"]);
...
var _mseController = __webpack_require__(7);

var _mseController2 = _interopRequireDefault(_mseController);

var _transmuxer = __webpack_require__(8);
...
var _chimeeHelperLog = __webpack_require__(1);
...
var _chimeeHelperUtils = __webpack_require__(21);

var _toxicUtils = __webpack_require__(22);
...
var Flv = function (_CustEvent) {
  ...
  function Flv(videodom, config) {
    ...
    _this2.box = 'flv';
    _this2.timer = null;
    _this2.config = (0, _toxicUtils.deepAssign)({}, _config2.default, config);
  ...
  _createClass(Flv, [{
    ...
    value: function load(src) {
      ...
      this.transmuxer = new _transmuxer2.default(this.mediaSource, this.config);
      ...
      this.transmuxer.on('error', function (handle) {
        ...
        _this5.transmuxer.pause();
        _this5.mediaSource.pause();
      });

      this.transmuxer.on('end', function (handle) {
        _this5.mediaSource.endOfStream();
      });
      ...
      this.transmuxer.on('mediaInfo', function (mediaInfo) {
        if (!_this5.mediaInfo) {
          ...
          _this5.video.addEventListener('seeking', (0, _chimeeHelperUtils.throttle)(_this5._seek.bind(_this5), 200, { leading: false }));
        }
      });
    ...
    value: function _seek(seconds) {
      ...
      if (this.isTimeinBuffered(currentTime)) {
        ...
        _chimeeHelperLog2.default.verbose(this.tag, 'do seek');
    ...
    value: function onmseUpdateEnd() {
      ...
      if (currentBufferEnd >= currentTime + this.config.lazyLoadMaxDuration && this.timer === null) {
        _chimeeHelperLog2.default.verbose(this.tag, 'Maximum buffering duration exceeded, suspend transmuxing task');
    ...
    value: function heartbeat() {
      ...
      if (needResume) {
        window.clearInterval(this.timer);
        this.timer = null;
        _chimeeHelperLog2.default.verbose(this.tag, 'Continue loading from paused position');
    ...
    value: function refresh() {
      if (this.transmuxer) {
        ...
        _chimeeHelperLog2.default.verbose(this.tag, 'transmuxer not ready');
      }
    }
  }]);
  ...
  _createClass(MSEController, [{
    ...
    */
    ...
    value: function doCleanupSourceBuffer(type) {
      _chimeeHelperLog2.default.verbose(this.tag, 'docleanBuffer');
      var currentTime = this.video.currentTime;
      var sb = this.sourceBuffer[type];
    ...
    value: function appendBuffer(data, type) {
      try {
        ...
        if (e.code === 22) {
          ...
          _chimeeHelperLog2.default.verbose(this.tag, 'MediaSource bufferFull');
...
var _webworkifyWebpack = __webpack_require__(14);

var _webworkifyWebpack2 = _interopRequireDefault(_webworkifyWebpack);

var _chimeeFlv2fmp = __webpack_require__(4);
...
var Transmuxer = function (_CustEvent) {
  ...
  function Transmuxer(mediaSource, config) {
    ...
    if (_this.config.webWorker) {
      _this.w = (0, _webworkifyWebpack2.default)(/*require.resolve*/(15));
  ...
  */
  ...
  _createClass(Transmuxer, [{
    ...
    key: 'loaderBindEvent',
    value: function loaderBindEvent() {
      var _this2 = this;
    ...
    */
    ...
    value: function arrivalDataCallback(data, byteStart, keyframePoint) {
      ...
      if (!this.CPU) {
        this.CPU = new _chimeeFlv2fmp2.default();
    ...
    value: function onDemuxError(type, info) {
      _chimeeHelperLog2.default.error(this.tag, 'DemuxError: type = ' + type + ', info = ' + info);
...
var _handleQuery = __webpack_require__(10);
...
exports.default = function (ctx) {
  ...
  function init() {
    CPU = new _chimeeFlv2fmp2.default();
    ...
    */
    ...
    if (( false ? 'undefined' : _typeof(exports)) !== UNDEF_TYPE) {
        ...
        */
        ...
        if (( false ? 'undefined' : _typeof(__webpack_require__(19))) === FUNC_TYPE && __webpack_require__(20)) {
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.chimeeHelperUtils = {});
})(undefined, function (exports) {
  'use strict';
  ...
  var isSymbol = USE_NATIVE$1 && _typeof2($Symbol.iterator) == 'symbol' ? function (it) {
    return (typeof it === 'undefined' ? 'undefined' : _typeof2(it)) == 'symbol';
  } : function (it) {
    return it instanceof $Symbol;
  };
...
(function (global, factory) {
  ( false ? 'undefined' : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : factory(global.toxicUtils = {});
})(undefined, function (exports) {
  'use strict';
