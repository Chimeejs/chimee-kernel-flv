...
var _xhrRange = __webpack_require__(16);
...
var _xhrMozChunk = __webpack_require__(18);
	...
	_createClass(Ioloader, [{
		...
		value: function selectLoader() {
			...
			if (this.webSocketURLReg.test(url)) {
				this.loader = new _websocket2.default(url, config);
			} else if (_fetch2.default.isSupport()) {
				this.loader = new _fetch2.default(url, config);
			} else if (_xhrMozChunk2.default.isSupport()) {
				this.loader = new _xhrMozChunk2.default(url, config);
			} else if (_xhrRange2.default.isSupport()) {
				this.loader = new _xhrRange2.default(url, config);
			}
...
var _flvParse = __webpack_require__(20);
...
var _flvdemux = __webpack_require__(22);

var _flvdemux2 = _interopRequireDefault(_flvdemux);

var _mediaInfo = __webpack_require__(25);
...
var _expGolomb = __webpack_require__(24);
...
var _ioLoader = __webpack_require__(4);
...
var _webworkifyWebpack = __webpack_require__(19);
...
var _handleRange = __webpack_require__(2);
...
var _flvTag = __webpack_require__(21);
...
var _decodeUTF = __webpack_require__(23);
