...
var _xhrRange = __webpack_require__(17);

var _xhrRange2 = _interopRequireDefault(_xhrRange);

var _websocket = __webpack_require__(18);

var _websocket2 = _interopRequireDefault(_websocket);

var _xhrMozChunk = __webpack_require__(19);
...
var _flvParse = __webpack_require__(21);

var _flvParse2 = _interopRequireDefault(_flvParse);

var _tagdemux = __webpack_require__(6);

var _tagdemux2 = _interopRequireDefault(_tagdemux);

var _mp4remux = __webpack_require__(8);

var _mp4remux2 = _interopRequireDefault(_mp4remux);

var _mp4moof = __webpack_require__(27);
...
var flv2fmp4 = function () {
    ...
    _createClass(flv2fmp4, [{
        ...
        value: function setflvBasefrist(arraybuff, baseTime) {
            ...
            if (_flvParse2.default.arrTag.length == 0) return offset;
            ...
            if (_flvParse2.default.arrTag.length > 0) {
                _tagdemux2.default.hasAudio = this.hasAudio = _flvParse2.default._hasAudio;
                _tagdemux2.default.hasVideo = this.hasVideo = _flvParse2.default._hasVideo;
        ...
        value: function metaSucc(mi) {
            ...
            if (this.onMediaInfo && mi) {
                this.onMediaInfo(mi || _tagdemux2.default._mediaInfo, { hasAudio: this.hasAudio, hasVideo: this.hasVideo });
            }
            // 获取ftyp和moov
...
var _flvdemux = __webpack_require__(23);

var _flvdemux2 = _interopRequireDefault(_flvdemux);

var _mediaInfo = __webpack_require__(26);

var _mediaInfo2 = _interopRequireDefault(_mediaInfo);

var _spsParser = __webpack_require__(7);
...
var _mseController = __webpack_require__(13);

var _mseController2 = _interopRequireDefault(_mseController);

var _transmuxer = __webpack_require__(14);
...
var _ioLoader = __webpack_require__(3);
...
var _webworkifyWebpack = __webpack_require__(20);

var _webworkifyWebpack2 = _interopRequireDefault(_webworkifyWebpack);

var _flv2fmp = __webpack_require__(5);
...
var Transmuxer = function (_CustEvent) {
  ...
  function Transmuxer(mediaSource, config) {
    ...
    if (_this.config.webWorker) {
      _this.w = (0, _webworkifyWebpack2.default)(/*require.resolve*/(31));
  ...
  _createClass(Transmuxer, [{
    ...
    */
    ...
    value: function arrivalDataCallback(data, byteStart, keyframePoint) {
      ...
      if (!this.CPU) {
        this.CPU = new _flv2fmp2.default();
...
var _handleQuery = __webpack_require__(16);
...
var _handleRange = __webpack_require__(4);
...
var _flvTag = __webpack_require__(22);
...
var _decodeUTF = __webpack_require__(24);
...
var _aacSilent = __webpack_require__(28);
...
var _mediaSegmentInfo = __webpack_require__(30);
