...
var Log$2 = _interopDefault(require('chimee-helper-log'));
...
var MSEController = function (_CustEvent) {
  ...
  _createClass(MSEController, [{
    ...
    value: function addSourceBuffer(type) {
      ...
      chimeeHelper.Log.verbose(this.tag, 'add sourcebuffer ' + type);
      var sb = this.sourceBuffer[type];
      sb.addEventListener('error', this.e.onSourceBufferError);
      sb.addEventListener('abort', function () {
        return chimeeHelper.Log.verbose(_this2.tag, 'sourceBuffer: abort');
      });
    ...
    value: function seek() {
      for (var type in this.sourceBuffer) {
        ...
        try {
          ...
          chimeeHelper.Log.error(this.tag, e.message);
        }
        this.queue[type] = [];
    ...
    */
		...
		value: function pump(reader, keyframePoint) {
			...
			return reader.read().then(function (result) {
				if (result.done) {
					Log$2.verbose(_this3.tag, 'load end');
				} else {
...
var Flv = function (_CustEvent) {
  ...
  _createClass(Flv, null, [{
    key: 'isSupport',
    value: function isSupport() {
      var parser = new chimeeHelper.UAParser();
  ...
  _createClass(Flv, [{
    ...
    value: function load(src) {
      ...
      this.transmuxer.on('mediaInfo', function (mediaInfo) {
        if (!_this5.mediaInfo) {
          ...
          _this5.video.addEventListener('seeking', chimeeHelper.throttle(_this5._seek.bind(_this5), 200, { leading: false }));
        }
      });
    ...
    value: function _seek(seconds) {
      ...
      if (this.isTimeinBuffered(currentTime)) {
        ...
        chimeeHelper.Log.verbose(this.tag, 'do seek');
